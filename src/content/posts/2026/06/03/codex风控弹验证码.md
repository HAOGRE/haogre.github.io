...
title: "Codex 弹二次验证/手机验证码：旧手机号不用了怎么办"
featured: false
draft: false
tags:
  - "随笔"
description: "Codex 弹二次验证或手机验证码时，旧手机号不用了怎么办？本文解释 OpenAI 账户手机号、MFA 手机号和可操作方案。"
---

## Codex 弹二次验证/手机验证码：旧手机号不用了怎么办

这两天 V2EX 上有几篇帖子在聊同一件事：Codex 登录或授权时突然弹二次验证，要求输入手机验证码，偏偏很多老账号当年注册时用的是接码平台、临时号，或者现在已经不用的手机号。平时 ChatGPT 网页还能进，一到 Codex 这里就卡住，才发现这个旧号码可能变成了账号风险点。
